 ...
 *
 */
public class JavaPerformanceBenchmarkNoClient {
  ...
  public static void main(String... args) throws Exception {
    ...
    if (System.getProperty("os.name").contains("indows")) {
      runCommandSync("mvn.cmd -f pom-performance-noclient.xml clean install -Dmaven.test.skip=true");
    } else {
      runCommandSync("mvn -f pom-performance-noclient.xml clean install -Dmaven.test.skip=true");
    }
    ...
    try {
      ...
      for (boolean genAll : genAllViews) {
        ...
        for (int numViews : numbersOfAffectedViews) {
          ...
          String command = String.format("java -jar performance-noclient.jar %s %s", genAll, numViews);
...
//           JavaPerformanceProcessNoClient.main(new String[] { String.valueOf(genAll), String.valueOf(numViews) });
