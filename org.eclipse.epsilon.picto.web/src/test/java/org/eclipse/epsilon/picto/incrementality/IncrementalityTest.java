...
class IncrementalityTest {
	...
	void testGeneration() throws Exception {
		...
		Set<String> generatedViews = setUp("socialnetwork/socialnetwork.model.picto",
...
//    System.out.println("--------------------------------------");
	...
	void testMultipleUpdates() throws Exception {
		...
		assertThat(generatedViews).as("Generated views from updating name to 'Bobby'").containsExactlyInAnyOrder("/",
				"/Readme", "/Custom/Alice and Bob", "/Social Network", "/Social Network/Bobby");
		...
		assertThat(generatedViews2).as("Generated views from deleting Bob").containsExactlyInAnyOrder("/", "/Readme",
				"/Custom/Alice and Bob", "/Social Network", "/Social Network/Alice", "/Stats");
		...
		assertThat(generatedViews3).as("Generated views from creating Dan").containsExactlyInAnyOrder("/", "/Readme",
				"/Custom/Alice and Bob", "/Social Network", "/Social Network/Alice", "/Social Network/Dan", "/Stats");
		...
		assertThat(generatedViews4).as("Generated views from creating Erin").containsExactlyInAnyOrder("/", "/Readme",
				"/Custom/Alice and Bob", "/Social Network", "/Social Network/Erin", "/Stats");
	}
}
